...
<form method="POST" action="editar.php">
    ...
    <select id="tipo" name="tipo" required>
        ...
        <option value="Mecânico" <?php if ($produto['tipo'] == 'Limpeza') echo 'selected'; ?>>Limpeza</option>
        <option value="Papelaria" <?php if ($produto['tipo'] == 'Eletrônico') echo 'selected'; ?>>Eletrônico</option>
        <option value="Vestuário" <?php if ($produto['tipo'] == 'Vestuário') echo 'selected'; ?>>Vestuário</option>
    </select>
